//This program demonstrates the binarySearch function, which performs a binary search on an integer array

//This search only works properly if values in the array are in ascending order
#include <iostream>
using namespace std;
