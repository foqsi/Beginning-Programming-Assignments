...
int main(){
    ...
    //Array with numbers of units sold for each product
...
//This function calculates each product's sales by multiplying its units sold         *
//by each unit's price. The result is stored in the sales array.                      *
//*************************************************************************************
...
//*************************************************************************************
//Defeinition of function dualSort. Accepts id and sales arrays as arguments          *
//The size of these arrays is passed into size. This function performs a descending   *
//order selection sort on the sales array. The elements of the id array are           *
//exchanged identically as those of the sales array. size is the number               *
...
//The size of these arrays is passed into num. The function first displays            *
//a heading, then the sorted list of products numbers and sales                       *
//*************************************************************************************
...
//The size fot hese arrays is passed into num. The function first calculates          *
//the total units(ofall products) sold and the total sales. It then displays these    *
//amounts.                                                                            *
//*************************************************************************************
